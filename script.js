...
document.querySelectorAll(".gallery-grid img").forEach(function(img){
  img.addEventListener("click", function(){
    ...
    if(box && preview){ preview.src=img.src; box.hidden=false; }
  });
});
const galleryClose=document.getElementById("galleryClose");
if(galleryClose) galleryClose.addEventListener("click",function(){
  document.getElementById("galleryLightbox").hidden=true;
});
const galleryLightbox=document.getElementById("galleryLightbox");
if(galleryLightbox) galleryLightbox.addEventListener("click",function(e){
  if(e.target===galleryLightbox) galleryLightbox.hidden=true;
});
